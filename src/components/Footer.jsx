...
export default function Footer() {
  return (
    <footer className="footer sm:footer-horizontal bg-base-100/60 text-base-content border-t border-base-content/10 px-4 sm:px-8 py-6 items-center justify-between">
